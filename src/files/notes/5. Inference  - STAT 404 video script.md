...
2. Formulate simple inference problems
    ...
    + **Video**: Inverse problems in science, mathematics, and statistics
    ...
    + **Video**: The art of modeling: making and justifying your choices when building a model
